...
const Login = () => {
  ...
  return (
    <div className='border rounded-md shadow'>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 max-w-2xl p-8">

        <div style={{ imageRendering: "pixelated" }}>
          <Image src="/assets/icons/title-crisp.png" alt="BhetGhat Logo" width={400} height={400} />
        </div>
        ...
        <Button type='submit' className='font-bold text-md'>LOGIN</Button>
